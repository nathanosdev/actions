...
- If you want to report an issue, click [issues](https://github.com/dfinity/actions/issues).
...
1. Click [create a new issue](https://github.com/dfinity/actions/issues/new).
...
2. Navigate to the [repository's homepage](https://github.com/dfinity/actions) in a web browser.
